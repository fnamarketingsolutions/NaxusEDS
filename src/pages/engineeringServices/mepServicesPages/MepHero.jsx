...
export default function MepHero() {
  // All hero layout configuration, copy changes for NexusEDS, and styling contained inside a single component and return statement
  return (
   <>
      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col justify-center text-center lg:text-left order-2 lg:order-1">
          ...
          <p className="mt-6 text-base md:text-lg text-neutral-600 max-w-xl mx-auto lg:mx-0 leading-relaxed">
            NexusEDS delivers sustainable, precision-engineered building systems. From complex HVAC automation to scalable power distribution and optimized hydraulic networks, we bring efficiency to your infrastructure.
          </p>
        ...
        <div className="relative w-full h-[320px] sm:h-[400px] lg:h-[500px] order-1 lg:order-2 flex items-center justify-center">
          ...
          <div className="w-full h-full rounded-2xl overflow-hidden relative">
            <img 
              src={mepHeroImage}
              alt="NexusEDS MEP Building Systems Engineering" 
            ...
            <div className="absolute bottom-4 right-4 bg-white/95 backdrop-blur-sm border border-neutral-200 px-4 py-2 rounded-lg flex items-center gap-2 shadow-sm">
              ...
              <span className="text-xs font-bold text-neutral-800 tracking-wide">NexusEDS Integrated Design</span>
            </div>
          </div>
        </div>
