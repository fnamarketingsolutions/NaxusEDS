      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="text-gray-500 text-sm md:text-base font-light leading-relaxed">
            How we translate your initial architectural design concepts into verified, engineering-grade structural layouts.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-stretch">
          ...
          {/* LEFT SIDE: SINGLE IMAGE BLOCK */}
          <div className="lg:col-span-5 w-full h-64 sm:h-96 lg:h-auto min-h-[320px]">
          ...
          {/* RIGHT SIDE: VERTICAL TIMELINE WITH COMPACT STEPS */}
          <div className="lg:col-span-7 relative flex flex-col justify-between py-2 pl-4 sm:pl-6">
            
            {/* Clean Vertical Line Indicator */}
                ...
                >
                  ...
                  <div className="flex flex-col space-y-1 pt-0.5">
                    <h4 className="text-base sm:text-lg font-bold text-gray-900 group-hover:text-[#A43025] transition-colors duration-300">
                      <span className="font-mono text-xs font-semibold mr-1.5 text-gray-400">0{idx + 1}.</span>
                      {step.title}
                    </h4>
                    <p className="text-gray-500 text-xs sm:text-sm font-light leading-relaxed max-w-2xl">
                      {step.desc}
                    </p>
                  </div>
                </motion.div>
